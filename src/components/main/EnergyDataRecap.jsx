...
const EnergyDataRecap = () => {
    ...
    return (
        <div className=' w-full flex-[2] bg-white rounded-xl p-5 flex flex-col gap-3 '>
            ...
            <div className=" flex flex-row justify-between">
                <div className=" flex flex-row gap-5">
                    ...
                    <div className=" flex flex-col p-3 border-2 border-gris rounded-xl gap-2">
                        <h1 className=" text-3xl text-vert font-bold">-7%</h1>
                        <p className=" text-lg">comparing to last month</p>
                    </div>
                </div>
                <div onClick={onClickDetailsEnergy} className="px-4 cursor-pointer self-end hidden md:flex flex-row items-center gap-3">
